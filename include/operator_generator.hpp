/**
 * @file operator_generator.hpp
 * @brief 演算子を生成する。詳しくはesaの「演算子を水増しする方法」を参照。
 */
...
namespace nhk24_2nd_ws::operator_generator::impl {
...
namespace nhk24_2nd_ws::operator_generator {
	using impl::UnaryOp;
	using impl::AutoUnaryOp;
	using impl::BinaryLeftOp;
	using impl::AutoBinaryLeftOp;
	using impl::PartialAppliedBinaryLeftOp;
