...
namespace nhk24_2nd_ws::string_literal
{
	...
	struct StringLiteral final {
		...
		explicit constexpr operator const decltype(value)&() const noexcept
		{
			return value;
		}
	...
	inline constexpr auto operator""_sl() noexcept
	{
		return sl;
	}
}